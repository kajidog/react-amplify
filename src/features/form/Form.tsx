...
export function FormComponent() {
  ...
  const [formData, setFormData] = useState<FormData>({ firstName: '', lastName: '', email: '' }); // フォームデータ
  ...
  return (
    <div>
      {step === 1 && <StepOne defaultValues={formData} onSubmit={handleStepOneSubmit} />}
      {step === 2 && <StepTwo defaultValues={formData} onSubmit={handleStepTwoSubmit} />}
